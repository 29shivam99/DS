...
let table = document.querySelector(".emp-data");
let tbody = table.querySelector(".emp-body");
let thead = table.querySelector(".emp-head");
...
function setPaginator() {
  ...
  pageNum = 1;
  maxPages = Math.ceil(totalItems / maxSize);

  start = maxSize * (pageNum - 1);
  end = start + maxSize;
}
...
function paginatorClickHandlers() {
